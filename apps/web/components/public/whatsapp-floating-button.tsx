...
export function WhatsAppFloatingButton({
  ...
  return (
    <div
      className={cn(
        // Physical right edge (independent of RTL logical start/end).
        "pointer-events-none fixed bottom-5 right-4 z-50 sm:bottom-6 sm:right-6",
        className,
      )}
    >
      <button
        ...
        className={cn(
          ...
          "hover:-translate-y-0.5 hover:shadow-[0_14px_32px_-8px_rgba(37,211,102,0.75)]",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/70",
      ...
      >
        ...
        <span
          className={cn(
            ...
            "whitespace-nowrap rounded-full border border-border/70 bg-card px-3 py-1.5",
