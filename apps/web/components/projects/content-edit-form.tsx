        ...
        <div className="space-y-3">
          {collageImageUrl ? (
            <div className="overflow-hidden rounded-xl border border-border/70 bg-card">
              <div className="border-b border-border/60 px-3.5 py-2.5 sm:px-4">
                <p className="text-sm font-semibold">استوری‌بورد تصویری</p>
                <p className="mt-0.5 text-[11px] text-muted-foreground">
                  همه صحنه‌ها در یک شیت؛ با تولید مجدد هوش مصنوعی به‌روز می‌شود
                </p>
              </div>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={collageImageUrl}
                alt="شیت استوری‌بورد تصویری"
                className="h-auto w-full bg-[#0f1115] object-contain object-top"
              />
            </div>
          ) : null}
          {scenes.map((scene, index) => (
            ...
            >
              ...
              {scene.imageUrl && !collageImageUrl ? (
